...
icon = Image.open(r"C:\Users\admin\Downloads\youtube.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Shivashankar",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Shivashankar!*"""})
